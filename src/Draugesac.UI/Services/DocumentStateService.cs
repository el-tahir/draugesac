...
public class DocumentStateService
{
    ...
    /// Typically called after a successful upload.
    /// </summary>
    ...
    /// Useful for tracking redaction progress or other status changes.
    /// </summary>
    ...
    {
        ClientDocumentInfo? document = _documents.FirstOrDefault(d => d.Id == documentId) ?? throw new ArgumentException($"Document with ID {documentId} not found in state", nameof(documentId));
